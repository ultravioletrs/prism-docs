...
To run algorithms, you need to have a prism installation. You can get it from [here](/getting-started/getting-started/). Also you need to have manager running. You can get it from [here](https://www.ultraviolet.rs/docs/cocos-ai/getting-started/).

Get familiar with running algorithms using cocos [here](https://www.ultraviolet.rs/docs/cocos-ai/algorithms/), before continuing.
