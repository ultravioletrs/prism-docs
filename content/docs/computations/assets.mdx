...
- **File Checksum**: The checksum of the actual file (not the sample), get more information on checksum [here](https://www.ultraviolet.rs/docs/cocos-ai/cli/#file-hash).
