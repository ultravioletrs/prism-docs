...
Detailed steps for creating a computation, uploading necessary assets, and managing public keys are available in [computations](/computations/computations/) and [events](/computations/assets/) docs.
