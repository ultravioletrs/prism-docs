...
4. **Download Attestation Policy**
   ...
   - Download the attestation policy file from the cvm page (You can also use [CLI commands](https://www.ultraviolet.rs/docs/cocos-ai/cli#command-policy)) to download the attestation policy.
...
More docs on CLI commands used: [sevsnpmeasure](https://www.ultraviolet.rs/docs/cocos-ai/cli#command-sevsnpmeasure) and [measurement](https://www.ultraviolet.rs/docs/cocos-ai/cli#subcommand-policy-measurement).
...
_Note:_ You can generate keys using [cocos-cli](https://www.ultraviolet.rs/docs/cocos-ai/cli/#command-keys), our command-line tool for computation management.
...
3. **Handle Results**
   ...
   - Download through [cocos-cli](https://www.ultraviolet.rs/docs/cocos-ai/cli#command-result)
...
1. **Generate Key Pair**
   ...
   - Follow [key generation guide](https://www.ultraviolet.rs/docs/cocos-ai/cli/#generate-keys)
...
- [Algorithm uploads](https://www.ultraviolet.rs/docs/cocos-ai/cli/#upload-algorithm)
- [Dataset uploads](https://www.ultraviolet.rs/docs/cocos-ai/cli/#upload-dataset)
- [Result retrieval](https://www.ultraviolet.rs/docs/cocos-ai/cli/#retrieve-result)
...
- [COCOS CLI Documentation](https://www.ultraviolet.rs/docs/cocos-ai/cli/)
- [Attestation Guide](https://www.ultraviolet.rs/docs/cocos-ai/attestation/)
