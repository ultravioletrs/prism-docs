...
Workspace invitations and roles are closely connected. Before you can invite someone to your workspace, you need to understand roles—because every invitation assigns the invited user to a specific role that determines their permissions. You can learn more about roles [here](/user-management/workspace-roles/)
